...
class Tetromino:
    ...
    def rotate_clockwise(self, direction, game_grid) :
        n = len(self.tile_matrix)  # n = number of rows = number of columns
        ...
        for row in range(n) :
            for col in range(n) :
                ...
                # modify the position of each occupied tile
    ...
    def rotate_counterclockwise(self, direction, game_grid) :
        n = len(self.tile_matrix)  # n = number of rows = number of columns
        rotated_matrix = np.full((n, n), None)
        for row in range(n) :
            for col in range(n) :
                ...
                # modify the position of each occupied tile
                position.x = self.bottom_left_corner.x + row
                position.y = self.bottom_left_corner.y + col
                self.tile_matrix[row][col].set_position(position)
        self.tile_matrix=rotated_matrix
